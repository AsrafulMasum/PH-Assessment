...
function BannerSlider() {
    return (
        <div style={{
            backgroundImage: `url('https://i.postimg.cc/zfMZ8RSC/overhead-view-blank-spiral-notepad-with-italian-pasta-ingredients-against-black-textured-backdrop.jpg')`,
                    ...
                    <SwiperSlide>
                        <div className='flex flex-col mx-48'>
                            ...
                            <div className='flex gap-4'>
                                <Button text="See Recipes" style="border-none bg-primary text-white px-10 text-lg" />
                                <button className='text-black hover:border-none text-lg px-10 bg-white rounded-lg font-semibold'>Add Recipes</button>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
